# -*- coding: utf-8 -*-
"""World Cup 2022 Project.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1q4-4hUlEjJ7lYnX7-mMgmNVF3-noAFXN
...
"""### 2.3 Plot Poss vs. PrgP using sns.lineplot, and create a scatterplot for Poss and PrgP"""
...
"""2.4 Plot Poss vs. Expected Goal(Eg) and Goal(Gls) using sns.lineplot, and create a scatterplot for Plot Poss vs. Expected Goal(Eg) and Goal(Gls)
...
"""2.5 Plot Poss vs. Assist(Ast) and Goal(Gls) using sns.lineplot, and create a scatterplot for Plot Poss vs. Assist(Ast) and Goal(Gls)"""
...
"""2.6 A histograph to show distribution of  Possession(Poss)"""
